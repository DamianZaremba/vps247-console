...
public class Test
{
  ...
  {
    1Obj obj = new JSONString("A beany object", 42.0D, true)
    {
      ...
      public String toJSONString() {
        return "{" + JSONObject.quote(Test.this) + ":" + 
    ...
    try
    {
      ...
      jj.key("big").value(1.23456789E+96D);
      ...
      j = new JSONObject(
        "{foo: [true, false,9876543210,    0.0, 1.00000001,  1.000000000001, 1.00000000000000001, .00000000000000001, 2.00, 0.1, 2e100, -32,[],{}, \"string\"],   to   : null, op : 'Good',ten:10} postfix comment");

      j.put("String", "98.6");
      j.put("JSONObject", new JSONObject());
      j.put("JSONArray", new JSONArray());
      j.put("int", 57);
      j.put("double", 1.234567890123457E+29D);
      j.put("true", true);
      j.put("false", false);
      ...
      System.out.print("Exception: ");
      try {
        System.out.println(a.put((0.0D / 0.0D)));
      } catch (Exception e) {
        System.out.println(e);
      }
      System.out.print("Exception: ");
